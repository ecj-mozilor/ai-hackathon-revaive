...
import GenerateButton from "@/components/employee/GenerateButton"
...
export default async function EmployeeDashboard() {
  ...
  if (questionnaire?.status === "GENERATED") {
  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      ...
      {questionnaire?.status === "READY_FOR_GENERATION" && (
        <div className="bg-indigo-50 border border-indigo-200 rounded-xl p-8 flex gap-4">
          ...
          <div>
            ...
            <p className="text-indigo-700 text-sm mb-5">
              Everything is in place. Generate your personalised learning path now.
            </p>
            <GenerateButton />
          </div>
        </div>
